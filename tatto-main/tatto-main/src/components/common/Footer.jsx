        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm leading-relaxed mb-6">
              Professional tattoo artistry with years of experience creating unique, custom designs that tell your story.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/" className="text-gray-400 hover:text-orange-500 transition-colors duration-300 text-sm">
                  Home
                </Link>
              </li>
              <li>
                <Link to="/about" className="text-gray-400 hover:text-orange-500 transition-colors duration-300 text-sm">
                  About Us
                </Link>
              </li>
              <li>
                <Link to="/gallery" className="text-gray-400 hover:text-orange-500 transition-colors duration-300 text-sm">
                  Gallery
                </Link>
              </li>
              <li>
                <Link to="/contact" className="text-gray-400 hover:text-orange-500 transition-colors duration-300 text-sm">
                  Contact Us
                </Link>
              </li>
            </ul>
          ...
          <div>
            <h4 className="text-lg font-bold uppercase tracking-wider mb-6">Working Hours</h4>
